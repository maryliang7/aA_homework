...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](searchTerm).then(function (res) {
...
function (_React$Component) {
  ...
  _createClass(GiphysIndex, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, this.props.giphys.map(function (giphy) {
